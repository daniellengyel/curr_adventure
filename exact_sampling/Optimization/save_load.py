...
def save_opt(opt_res, opt_type, test_problem_name, sig, noise_type, c1, c2, seed, additional_info=None):
    save_name = "{}_{}_{}_{}_{}".format(noise_type, sig, c1, c2, seed)
    if additional_info is not None:
        for k in additional_info:
            save_name += "_{}_{}".format(k, additional_info[k])
    save_dir_path = "/Users/daniellengyel/curr_adventure/exact_sampling/OptimizationResults/{}/{}".format(opt_type, test_problem_name)
